  ...
  return (
    <Link 
      ...
      <div className={style["result-item"]}>
        ...
        <span className={style["identification"]}>{vol ? `${vol.volValue * Math.pow(10, vol.volExponent)} km3` : "unknown"}</span>
        <span className={style["identification"]}>{sideralOrbit} days</span>
